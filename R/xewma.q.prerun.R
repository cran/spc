...
xewma.q.prerun <- function(l, c, mu, p, zr=0, hs=0, sided="two", limits="fix", q=1, size=100, df=NULL, estimated="mu", qm.mu=30, qm.sigma=30, truncate=1e-10) {
  ...
  quant <- .C("xewma_q_prerun",
              ...
              as.integer(qm.mu), as.integer(qm.sigma), as.double(truncate),
