...
xewma.sf.prerun <- function(l, c, mu, n, zr=0, hs=0, sided="one", limits="fix", q=1, size=100, df=NULL, estimated="mu", qm.mu=30, qm.sigma=30, truncate=1e-10, tail_approx=TRUE) {
  ...
  sf <- .C("xewma_sf_prerun",
           ...
           as.integer(qm.mu), as.integer(qm.sigma), as.double(truncate), as.integer(tail_approx),
